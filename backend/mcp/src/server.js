...
import { compareStates, compareStatesSchema, getFleetByState, getFleetByStateSchema, getVehicleDistribution, getVehicleDistributionSchema, } from "./tools/senatran.js";
import { predictVehiclePrice, predictVehiclePriceSchema } from "./tools/vehiclePrice.js";
function createServer() {
    ...
    server.registerTool("get_vehicle_distribution", {
        title: "Distribuição da frota por categoria",
        description: "Calcula a distribuição percentual da frota de veículos da SENATRAN por categoria para uma unidade federativa.",
    ...
    server.registerTool("predict_vehicle_price", {
        title: "Prever o preço do veículo",
        description: "Estima o preço de um veículo utilizando o modelo de Machine Learning.",
